...
?>
  ...
  <?php echo " Bag Calculate<hr><br>"; echo $bagTotal = bagCalculate($length, $width, $depth); echo " bags needed<hr><br>"; ?>
  <?php echo  " Amaount Total £".$priceTotal = calculatePrice(bagCalculate($length, $width, $depth)); echo " (VAT inc.)<hr>"; ?>
